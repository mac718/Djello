...
export const SWITCH_TO_CARD_DESCRIPTION_FORM =
  "SWITCH_TO_CARD_DESCRIPTION_FORM";
...
export const CLOSE_DELETE_LIST_WARNING_MODAL =
  "CLOSE_DELETE_LIST_WARNING_MODAL";
export const SHOW_DELETE_BOARD_WARNING_MODAL =
  "SHOW_DELETE_BOARD_WARNING_MODAL";
...
export const CLOSE_DELETE_CARD_WARNING_MODAL =
  "CLOSE_DELETE_CARD_WARNING_MODAL";
  ...
  return (dispatch, getState) => {
    ...
    fetch("./addChecklistItem", {
      ...
      .then((json) => {
        if (json.error) {
          alert(
            "Uh oh, something went wrong: " + JSON.stringify(json.error.message)
          );
        } else {
          dispatch(updateActiveBoardLists(json.lists));
          dispatch(updateCurrentUser(json.user));
